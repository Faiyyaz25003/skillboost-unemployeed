...
function Hero() {
  return (
    <section className="relative overflow-hidden bg-slate-950">
      ...
      />
      <div className="relative mx-auto grid max-w-7xl grid-cols-1 items-center gap-8 px-4 py-12 sm:gap-10 sm:px-6 sm:py-16 lg:grid-cols-2 lg:pb-16">
        <div>
          ...
          <h1 className="mt-5 font-display text-3xl font-extrabold leading-[1.15] text-white sm:text-4xl sm:leading-[1.1] lg:text-5xl">
            Find Your Dream Job
          ...
          <div className="mt-7 flex flex-col gap-2 rounded-xl bg-white p-2 shadow-xl sm:flex-row sm:items-center">
            <div className="flex flex-1 items-center gap-2 px-3 py-2">
              ...
              <input
                ...
                className="w-full min-w-0 font-body text-sm text-gray-700 placeholder-gray-400 outline-none"
              />
            </div>
            ...
            <button className="w-full rounded-lg bg-teal-600 px-6 py-3 font-body text-sm font-semibold text-white transition hover:bg-teal-700 sm:w-auto">
              Search Jobs
            </button>
          </div>
      ...
      {/* Mobile/tablet-only stats row so the info isn't lost below lg */}
      <div className="relative grid grid-cols-2 gap-3 px-4 pb-10 sm:grid-cols-4 sm:gap-4 sm:px-6 lg:hidden">
        {STATS.map(({ icon: Icon, value, label, color }) => (
          <div
            key={label}
            className="flex items-center gap-2.5 rounded-xl bg-white p-3 shadow-lg dark:bg-slate-900"
          >
            <span
            ...
            <div className="min-w-0">
              ...
              <p className="truncate font-body text-[11px] text-gray-500 dark:text-slate-400">
                {label}
              </p>
            </div>
          </div>
...
function TopHiringPartners() {
  return (
    <section className="mx-auto max-w-7xl px-4 sm:-mt-8 sm:px-6">
      <div className="relative z-10 rounded-xl border border-gray-100 bg-white p-5 shadow-md dark:border-white/10 dark:bg-slate-900 sm:p-6">
        <p className="mb-4 text-center font-body text-xs font-semibold uppercase tracking-wide text-gray-400 dark:text-slate-500">
          Top Hiring Partners
        </p>
        <div className="flex flex-wrap items-center justify-center gap-x-6 gap-y-3 sm:flex-nowrap sm:justify-between sm:gap-6 sm:overflow-x-auto">
          {PARTNERS.map((name) => (
            <span
              key={name}
              className="shrink-0 cursor-pointer font-display text-base font-bold text-gray-300 grayscale transition hover:text-teal-600 hover:grayscale-0 dark:text-slate-600 dark:hover:text-teal-400 sm:text-lg"
            >
              {name}
            </span>
          ))}
          <ChevronRight
            className="hidden shrink-0 text-gray-300 dark:text-slate-600 sm:block"
            size={18}
          />
        </div>
      </div>
    ...
    <aside className="space-y-5">
          ...
          <div className="space-y-2">
            {JOB_TYPES.map((t) => (
              ...
              >
                <input
                  type="checkbox"
                  className="h-3.5 w-3.5 shrink-0 rounded border-gray-300 accent-teal-600"
                />
                {t.label}{" "}
      ...
      <div className="rounded-xl border border-gray-100 bg-white p-5 shadow-sm dark:border-white/10 dark:bg-slate-900">
        ...
        <input
          ...
          className="mt-3 w-full min-w-0 rounded-lg border border-gray-200 px-3 py-2 font-body text-xs outline-none focus:border-teal-400 dark:border-white/10 dark:bg-slate-800 dark:text-white"
        />
...
function JobCard({ job }) {
  ...
  return (
    <div className="flex flex-col gap-4 rounded-xl border border-gray-100 bg-white p-4 shadow-sm transition hover:-translate-y-0.5 hover:shadow-md dark:border-white/10 dark:bg-slate-900 sm:p-5 lg:flex-row lg:items-center lg:justify-between">
      <div className="flex min-w-0 gap-3 sm:gap-4">
        <div
          className={`flex h-11 w-11 shrink-0 items-center justify-center rounded-lg font-display text-sm font-bold sm:h-12 sm:w-12 ${job.color} dark:border-white/10`}
        >
          {job.initial}
        </div>
        <div className="min-w-0">
      ...
      <div className="flex shrink-0 items-center justify-between gap-4 border-t border-gray-100 pt-3 dark:border-white/10 lg:justify-end lg:border-t-0 lg:pt-0">
  ...
  return (
    <div className="space-y-4">
      ...
      <div className="flex flex-wrap items-center justify-center gap-1.5 pt-4">
        <button className="flex h-8 w-8 shrink-0 items-center justify-center rounded-lg border border-gray-200 text-gray-400 hover:bg-gray-50 dark:border-white/10 dark:text-slate-500 dark:hover:bg-white/5">
          <ChevronLeft size={14} />
        </button>
        {[1, 2, 3, 4].map((n) => (
          <button
            ...
            className={
              n === 1
                ? "flex h-8 w-8 shrink-0 items-center justify-center rounded-lg bg-teal-600 font-body text-sm font-semibold text-white"
                : "flex h-8 w-8 shrink-0 items-center justify-center rounded-lg border border-gray-200 font-body text-sm text-gray-600 hover:bg-gray-50 dark:border-white/10 dark:text-slate-300 dark:hover:bg-white/5"
            }
          >
            {n}
          </button>
        ...
        <button className="flex h-8 w-8 shrink-0 items-center justify-center rounded-lg border border-gray-200 font-body text-sm text-gray-600 hover:bg-gray-50 dark:border-white/10 dark:text-slate-300 dark:hover:bg-white/5">
          25
        </button>
        <button className="flex h-8 w-8 shrink-0 items-center justify-center rounded-lg border border-gray-200 text-gray-400 hover:bg-gray-50 dark:border-white/10 dark:text-slate-500 dark:hover:bg-white/5">
...
function CtaBanner() {
  return (
    <section className="mx-auto max-w-7xl px-4 py-10 sm:px-6">
      <div className="flex flex-col items-stretch justify-between gap-5 rounded-xl bg-slate-950 px-5 py-8 sm:flex-row sm:items-center sm:px-8">
        ...
        <div className="flex flex-col shrink-0 gap-3 sm:flex-row">
          <button className="flex items-center justify-center gap-2 rounded-lg bg-white px-4 py-2.5 font-body text-sm font-semibold text-slate-900 transition hover:bg-slate-100">
            <Upload size={15} /> Upload Resume
          </button>
          <button className="flex items-center justify-center gap-2 rounded-lg bg-teal-600 px-4 py-2.5 font-body text-sm font-semibold text-white transition hover:bg-teal-700">
...
export default function Jobs() {
  ...
  return (
    <div className={dark ? "dark" : ""}>
      <FontLoader />
      <div className="min-h-screen overflow-x-hidden bg-gray-50 font-body dark:bg-slate-950">
        <Hero />
        <TopHiringPartners />

        <main className="mx-auto grid max-w-7xl grid-cols-1 gap-6 px-4 py-10 sm:px-6 lg:grid-cols-[280px_1fr]">
          <Sidebar />
          <JobListings />
        </main>
