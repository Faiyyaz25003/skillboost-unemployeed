  ...
  return (
    <main className="bg-white overflow-x-hidden">
      ...
      <section className="bg-[#EAF1FE]">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 py-10 sm:py-14 grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-10 items-center">
          {/* Left */}
          <div className="text-center lg:text-left">
            ...
            <p className="mt-4 sm:mt-5 text-gray-500 max-w-md mx-auto lg:mx-0 text-sm sm:text-base">
              Have questions or need more information? Our team is ready to
              assist you. Get in touch with us anytime.
            </p>

            <div className="mt-6 sm:mt-8 flex flex-col sm:flex-row items-center gap-3 justify-center lg:justify-start">
          ...
          <div className="relative flex justify-center order-first lg:order-last">
            <img
              ...
              className="w-full max-w-md sm:max-w-lg lg:max-w-2xl h-auto object-contain rounded-2xl"
            />
          </div>
        </div>
      </section>
      ...
      {/* ---------- FORM + GET IN TOUCH ---------- */}
      <section className="mx-auto max-w-7xl px-4 sm:px-6 py-12 sm:py-16 grid grid-cols-1 lg:grid-cols-2 gap-8">
        {/* Send message form */}
        <div className="border border-gray-200 rounded-2xl p-5 sm:p-8 shadow-sm">
          ...
          <form className="space-y-5">
            ...
            <button
              type="submit"
              className="w-full sm:w-auto inline-flex items-center justify-center gap-2 bg-blue-600 hover:bg-blue-700 transition-colors text-white font-medium px-6 py-3 rounded-lg text-sm"
            >
      ...
      <section className="mx-auto max-w-7xl px-4 sm:px-6 pb-12 sm:pb-16">
        <div className="relative rounded-2xl overflow-hidden border border-gray-200">
          <iframe
            ...
            allowFullScreen
          />
          <div className="absolute top-4 left-4 right-4 sm:top-6 sm:left-6 sm:right-auto bg-white rounded-xl shadow-lg p-4 sm:p-5 w-auto sm:w-72">
            <div className="flex items-start gap-2">
              ...
              <div>
                ...
                <a
                  ...
                  className="text-blue-600 text-xs sm:text-sm font-medium mt-2 inline-block"
                >
                  View on Google Maps
                </a>
              </div>
          ...
          {[
            ...
            >
              <img
                ...
                className="w-full h-24 sm:h-28 object-cover bg-gray-200"
              />
              <div className="p-3">
      ...
      {/* ---------- CTA BANNER ---------- */}
      <section className="mx-auto max-w-7xl px-4 sm:px-6 pb-12 sm:pb-16">
        <div className="bg-blue-700 rounded-2xl px-6 sm:px-8 py-6 flex flex-col md:flex-row items-center justify-between gap-5 text-center md:text-left">
          ...
          <div className="flex flex-col sm:flex-row items-center gap-3 w-full md:w-auto">
            <button className="w-full sm:w-auto inline-flex items-center justify-center gap-2 border border-white/60 text-white text-sm font-medium px-5 py-2.5 rounded-lg hover:bg-white/10 transition-colors">
              <MessageCircle className="w-4 h-4" />
              Chat with AI Assistant
            </button>
            <button className="w-full sm:w-auto inline-flex items-center justify-center gap-2 bg-orange-500 hover:bg-orange-600 transition-colors text-white text-sm font-medium px-5 py-2.5 rounded-lg">
...
function ContactCard({
  ...
  return (
    <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 border border-gray-200 rounded-xl px-4 sm:px-5 py-4">
      <div className="flex items-start gap-4 min-w-0">
        ...
        <div className="min-w-0">
          ...
          {lines.map((line, i) => (
            <p key={i} className={`text-sm ${linesClassName} break-words`}>
              {line}
            </p>
          ))}
        </div>
      </div>
      <div className="text-left sm:text-right text-xs text-gray-400 shrink-0 pl-14 sm:pl-0">
        {meta.map((line, i) => (
          <p key={i}>{line}</p>
        ))}
      </div>
