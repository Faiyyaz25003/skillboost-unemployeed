  ...
  return (
    <div className="min-h-screen bg-slate-50 text-slate-800 overflow-x-hidden">
      ...
      <section className="relative bg-gradient-to-r from-blue-800 to-blue-700 overflow-hidden">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 py-10 sm:py-14 grid lg:grid-cols-2 gap-8 lg:gap-10 items-center relative">
          <div>
            ...
            <div className="flex flex-col xs:flex-row sm:flex-row flex-wrap items-stretch sm:items-center gap-3 sm:gap-4 mt-8">
              <button className="bg-orange-500 hover:bg-orange-600 text-white font-semibold px-5 py-3 rounded-md text-sm flex items-center justify-center gap-2">
          ...
          <div className="relative mt-10 lg:mt-0">
            <div className="rounded-2xl overflow-hidden bg-blue-900/30 aspect-[4/3] flex items-center justify-center text-blue-200 text-sm">
              <img src="HomeHero.jpeg" className="w-full h-full object-cover" alt="Recruiter hero" />
            </div>
            ...
            {/* Compact stat row shown only on small screens, replacing the floating cards */}
            <div className="flex md:hidden justify-between gap-2 mt-4">
              <div className="flex-1 bg-white rounded-xl shadow-sm px-3 py-3 flex flex-col items-center text-center">
                <Users className="text-blue-700 mb-1" size={18} />
                <p className="font-bold text-sm leading-none">5000+</p>
                <p className="text-[10px] text-slate-500 mt-1">Job Ready</p>
              </div>
              <div className="flex-1 bg-white rounded-xl shadow-sm px-3 py-3 flex flex-col items-center text-center">
                <Building2 className="text-emerald-600 mb-1" size={18} />
                <p className="font-bold text-sm leading-none">200+</p>
                <p className="text-[10px] text-slate-500 mt-1">Partners</p>
              </div>
              <div className="flex-1 bg-white rounded-xl shadow-sm px-3 py-3 flex flex-col items-center text-center">
                <BarChart3 className="text-blue-700 mb-1" size={18} />
                <p className="font-bold text-sm leading-none">95%</p>
                <p className="text-[10px] text-slate-500 mt-1">Placement</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 -mt-8 relative z-10">
        <div className="bg-white rounded-xl shadow-md px-4 sm:px-8 py-6">
          <p className="text-center text-xs text-slate-400 mb-4">
            Trusted by 200+ Leading Companies
          </p>
          <div className="flex flex-wrap items-center justify-center gap-4 sm:gap-8 text-slate-400 font-semibold text-xs sm:text-sm">
            <span>Google</span>
            <span>Microsoft</span>
            <span>TCS</span>
            <span>Wipro</span>
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 py-12 sm:py-16 text-center">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-6 gap-4 sm:gap-5 mt-8 sm:mt-10">
          {[
            {
              icon: Users,
              color: "bg-blue-700",
            ...
            <div
              key={item.title}
              className="bg-white rounded-xl shadow-sm border border-slate-100 px-4 sm:px-5 py-6 sm:py-8 hover:shadow-md transition-shadow"
            >
              <div
      ...
      <section className="bg-blue-800">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 py-8 grid grid-cols-2 md:grid-cols-5 gap-6 sm:gap-8 text-center">
          {[
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 py-12 sm:py-16 grid lg:grid-cols-2 gap-6 sm:gap-8">
        {/* Left card */}
        <div className="bg-blue-50 rounded-2xl p-6 sm:p-8">
          <span className="text-xs font-semibold text-blue-700">
            For Recruiters
          </span>
          <h3 className="text-xl sm:text-2xl font-bold text-slate-900 mt-2 mb-5">
          ...
          <ul className="space-y-3 mb-6">
            {[
              ...
              <li
                key={li}
                className="flex items-start sm:items-center gap-2 text-sm text-slate-700"
              >
                <span className="w-5 h-5 shrink-0 rounded-full bg-emerald-500 text-white flex items-center justify-center text-[10px] mt-0.5 sm:mt-0">
                  ✓
                </span>
                {li}
              </li>
        ...
        <div className="bg-white rounded-2xl border border-slate-100 p-6 sm:p-8">
          ...
          <div className="divide-y divide-slate-100">
            {[
              ...
              <div
                key={job.title}
                className="flex flex-wrap sm:flex-nowrap items-center justify-between gap-2 py-4 first:pt-0"
              >
                <div className="flex items-center gap-3 min-w-0">
                  <div className="w-10 h-10 shrink-0 rounded-lg bg-slate-100 flex items-center justify-center text-blue-700 font-bold text-xs">
                    {job.title.charAt(0)}
                  </div>
                ...
                <div className="flex sm:hidden items-center gap-1 text-xs text-slate-400 ml-[52px] sm:ml-0">
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6">
        <div className="bg-blue-50 rounded-2xl px-6 sm:px-8 py-8 flex flex-col md:flex-row items-center text-center md:text-left justify-between gap-6">
          <div>
          ...
          <div className="flex flex-col items-center gap-2 shrink-0">
            <button className="bg-blue-800 hover:bg-blue-900 text-white text-sm font-semibold px-6 py-3 rounded-md w-full sm:w-auto">
              Request Talent
            </button>
            <a
              href="#"
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 py-12 sm:py-16">
        ...
        <div className="flex items-center gap-4">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-2 lg:grid-cols-5 gap-3 sm:gap-5 flex-1">
            {[
              {
                name: "Aman Verma",
              ...
              <div
                key={c.name}
                className="bg-white rounded-xl border border-slate-100 p-4 sm:p-5 shadow-sm hover:shadow-md transition-shadow"
              >
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6">
        <div className="bg-blue-800 rounded-2xl px-6 sm:px-8 py-8 flex flex-col md:flex-row items-center text-center md:text-left justify-between gap-6">
          ...
          <div className="flex flex-col sm:flex-row items-center gap-3 w-full sm:w-auto">
            <button className="bg-orange-500 hover:bg-orange-600 text-white text-sm font-semibold px-5 py-3 rounded-md w-full sm:w-auto">
              Post a Job Now
            </button>
            <button className="border border-white text-white text-sm font-semibold px-5 py-3 rounded-md hover:bg-white/10 w-full sm:w-auto">
              Contact Us
            </button>
          </div>
        </div>
