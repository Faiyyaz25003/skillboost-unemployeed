...
export default function About() {
  return (
    <main className="min-h-screen bg-[var(--color-bg)] overflow-x-hidden">
      {/* Hero */}
      <section className="relative overflow-hidden bg-gradient-to-r from-[var(--color-primary)] to-[#1E3A8A] rounded-b-[24px] sm:rounded-b-[40px]">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 py-10 sm:py-14 lg:py-16 grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-10 items-center">
          <div>
            ...
            <p className="text-white/85 max-w-md mb-6 text-sm sm:text-base">
          ...
          <div className="relative">
            <img
              ...
              className="rounded-2xl w-full h-[220px] sm:h-[280px] lg:h-[320px] object-cover"
            />
          </div>
        </div>
      </section>
      ...
      {/* Who We Are */}
      <section className="mx-auto max-w-7xl px-4 sm:px-6 py-12 sm:py-16 lg:py-20 grid grid-cols-1 lg:grid-cols-2 gap-10 sm:gap-12 lg:gap-14 items-center">
        <div className="relative flex justify-center">
          <img
            src="https://images.unsplash.com/photo-1562774053-701939374585?w=700&q=80"
            alt="SkillUp campus building"
            className="rounded-2xl w-full max-w-md h-[260px] sm:h-[320px] lg:h-[380px] object-cover"
          />
          <img
            src="https://images.unsplash.com/photo-1600880292203-757bb62b4baf?w=500&q=80"
            alt="Team working at desks"
            className="hidden sm:block absolute -bottom-6 -right-2 lg:-bottom-8 rounded-xl w-40 h-28 lg:w-56 lg:h-40 object-cover border-4 border-white shadow-xl"
          />
        </div>
        <div>
          ...
          <div className="card grid grid-cols-2 sm:grid-cols-4 gap-4 p-4 sm:p-6">
            {stats.map((stat) => (
      ...
      <section className="mx-auto max-w-7xl px-4 sm:px-6 py-12 sm:py-16">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5 sm:gap-6">
          {whyChoose.map((item) => (
            <div
              key={item.title}
              className="card p-5 sm:p-6 text-center hover:shadow-lg transition-shadow"
            >
              <div
      ...
      {/* Courses */}
      <section className="mx-auto max-w-7xl px-4 sm:px-6 py-12 sm:py-16">
        <div className="flex flex-col sm:flex-row items-center sm:items-end justify-between gap-3 mb-10 sm:mb-12 text-center sm:text-left">
          <div className="w-full">
            <p className="text-[var(--color-secondary)] text-xs font-bold tracking-wide uppercase mb-2">
              Our Courses
            </p>
            <h2 className="!text-2xl sm:!text-3xl">
              Job Oriented Courses We Offer
            </h2>
          </div>
          <Link
            href="#"
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5 sm:gap-6">
          {courses.map((course) => (
            <div
              key={course.title}
              className="card p-5 sm:p-6 hover:shadow-lg transition-shadow"
            >
              <div
      ...
      <section className="mx-auto max-w-7xl px-4 sm:px-6 py-12 sm:py-16">
        <div className="flex flex-col sm:flex-row items-center sm:items-end justify-between gap-3 mb-10 sm:mb-12 text-center sm:text-left">
          <div className="w-full">
            ...
            <h2 className="!text-2xl sm:!text-3xl">Our Latest Events</h2>
          </div>
          <Link
            href="#"
            className="hidden sm:flex shrink-0 items-center gap-1 text-[var(--color-primary)] text-sm font-semibold whitespace-nowrap"
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5 sm:gap-6">
          {events.map((event) => (
            <div
              key={event.title}
              className="relative rounded-[var(--radius-card)] overflow-hidden h-52 sm:h-56 text-white group"
            >
              <img
      ...
      <section className="mx-auto max-w-7xl px-4 sm:px-6 py-12 sm:py-16">
        <div className="flex flex-col sm:flex-row items-center sm:items-end justify-between gap-3 mb-10 sm:mb-12 text-center sm:text-left">
          <div className="w-full">
            ...
            <h2 className="!text-2xl sm:!text-3xl">Our Proud Achievers</h2>
          </div>
          <Link
            href="#"
            className="hidden sm:flex shrink-0 items-center gap-1 text-[var(--color-primary)] text-sm font-semibold whitespace-nowrap"
        ...
        <div className="relative">
          <div className="grid grid-cols-2 sm:grid-cols-2 lg:grid-cols-5 gap-4 sm:gap-6">
            {achievers.map((person) => (
              <div key={person.name} className="card p-4 sm:p-5 text-center">
                <img
                  src={`https://placehold.co/80x80/1E40AF/FFFFFF?text=${person.name.charAt(0)}`}
                  alt={person.name}
                  className="h-14 w-14 sm:h-16 sm:w-16 rounded-full mx-auto mb-3 object-cover"
                />
      ...
      {/* Certifications */}
      <section className="bg-gradient-to-r from-[var(--color-primary)] to-[#1E3A8A] py-12 sm:py-14">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 text-center">
          ...
          <div className="flex flex-wrap justify-center gap-3 sm:gap-4">
            {certifications.map((name) => (
              <div
                key={name}
                className="bg-white rounded-xl px-6 sm:px-8 py-3 sm:py-4 font-bold text-base sm:text-lg text-gray-700 min-w-[120px] sm:min-w-[140px]"
              >
                {name}
              </div>
            ))}
      ...
      {/* CTA */}
      <section className="mx-auto max-w-7xl px-4 sm:px-6 py-12 sm:py-16 grid grid-cols-1 sm:grid-cols-[auto_1fr] items-center gap-8 sm:gap-10">
        <img
          src="https://images.unsplash.com/photo-1607346256330-dee7af15f7c5?w=400&q=80"
          alt="Successful SkillUp graduate"
          className="h-32 w-32 sm:h-40 sm:w-40 rounded-full object-cover mx-auto sm:mx-0"
        />
        <div className="text-center sm:text-left">
          ...
          <div className="flex flex-wrap justify-center sm:justify-start gap-3 sm:gap-4">
            <button className="btn-primary px-5 sm:px-6 py-3 text-sm font-semibold">
              Explore Courses
            </button>
            <button className="btn-accent px-5 sm:px-6 py-3 text-sm font-semibold flex items-center gap-2">
